...
flowchart TD
    G(["OVERALL GOAL
    Strengthen effectiveness, sustainability & equity
    of MPA Development across BAI Sites"])

    G --> O1 & O2 & O3 & O4 & O5

    subgraph NAT["  NATIONAL LEVEL — Rekam Nusantara  "]
        O1["Obj 1
        Strengthen Scientific Foundation
        for MPA Management"]
        O5["Obj 5
    ...
    subgraph PROV["  PROVINCIAL LEVEL — Joint Collaboration  "]
        O2["Obj 2
        Develop Effective MPA
        Management Framework"]
    end

    subgraph SITE["  SITE & COMMUNITY LEVEL — Blue Alliance  "]
        O3["Obj 3
        Empower Coastal
        Communities"]
        O4["Obj 4
    ...
    O1 --> R1["Fisheries & ecosystem data
    Peer-reviewed publications
    Technical reports"]
    O2 --> R2["Science-based MPA management plans
    Ocean accounting integrated
    into governance frameworks"]
    O3 --> R3["Community conservation agreements
    Sustainable livelihoods
    Local capacity built"]
    O4 --> R4["Blue economy enterprises operational
    Blue carbon pipeline
    Long-term conservation finance"]
    O5 --> R5["Policy briefs & advocacy
    Science communications
    National & international visibility"]

    R1 & R2 & R3 & R4 & R5 --> IMP(["IMPACT
    Effective, Financially Sustainable & Equitable
    MPA Governance across BAI Sites"])
```
